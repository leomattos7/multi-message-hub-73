...
export const conversationService = {
  ...
  async getConversation(id: string) {
    try {
      ...
      // Handle potential error from conversation_to_tag
      const conversationTags = Array.isArray(data.conversation_to_tag) 
        ? data.conversation_to_tag 
        : [];
...
export const doctorProfileService = {
  ...
  async getProfileBySlug(slug: string) {
    try {
      ...
      // Get the doctor's links in a separate query if profile exists
      if (data) {
        ...
        // Use type assertion to add the doctor_links property
        return {
          ...data,
